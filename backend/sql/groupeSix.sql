...
-- Volcando estructura para tabla groupesix.carrito
...
-- Volcando datos para la tabla groupesix.carrito: ~0 rows (aproximadamente)

-- Volcando estructura para tabla groupesix.carritoproducto
...
-- Volcando datos para la tabla groupesix.carritoproducto: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla groupesix.comentario: ~34 rows (aproximadamente)
...
-- Volcando estructura para tabla groupesix.costos
CREATE TABLE IF NOT EXISTS `costos` (
  `id_costos` int(11) NOT NULL,
  `id_carrito` int(11) DEFAULT NULL,
  `subtotalGeneral` decimal(10,2) DEFAULT NULL,
  `costoEnvio` decimal(10,2) DEFAULT NULL,
  `totalGeneral` decimal(10,2) DEFAULT NULL,
  `moneda` varchar(3) DEFAULT NULL,
  PRIMARY KEY (`id_costos`),
  KEY `id_carrito` (`id_carrito`),
  CONSTRAINT `costos_ibfk_1` FOREIGN KEY (`id_carrito`) REFERENCES `carrito` (`id_carrito`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla groupesix.costos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla groupesix.direccion: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla groupesix.orden: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla groupesix.orden_items: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla groupesix.pago: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla groupesix.producto: ~14 rows (aproximadamente)
...
-- Volcando datos para la tabla groupesix.producto_imagen: ~56 rows (aproximadamente)
...
-- Volcando estructura para tabla groupesix.tipometodo
CREATE TABLE IF NOT EXISTS `tipometodo` (
  `id_metodoPago` int(11) NOT NULL,
  `tipoMetodo` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_metodoPago`),
  UNIQUE KEY `tipoMetodo` (`tipoMetodo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla groupesix.tipometodo: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla groupesix.tipo_envio: ~0 rows (aproximadamente)
